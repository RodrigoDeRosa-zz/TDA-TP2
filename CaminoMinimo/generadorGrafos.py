...
def main():
    ...
    #creador.crearArchivo(500, FILE_4);
    #creador.crearArchivo(1000, FILE_5);
    #creador.crearArchivo(5000, FILE_6);
    #creador.crearArchivo(10000, FILE_7);
    #creador.crearArchivo(50000, FILE_8);
    #creador.crearArchivo(100000, FILE_9);
    #creador.crearArchivo(500000, FILE_10);
    #creador.crearArchivo(1000000, FILE_11);
